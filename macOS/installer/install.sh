...
if [[ "$(uname)" != "Darwin" ]]; then
    echo "This is the BloxySpin macOS version, and should be only running on macOS. Please select" $(uname)
    exit 1
fi
...
echo "please wait while i'm installing bloxxyspin..."
...
echo "-----------------------"
echo "the whole bloxyspin is wishing you luck on your bets!"
echo "manged and developed by app.bloxyspin.com"
